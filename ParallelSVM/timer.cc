...
void Timer::CommunicationStart() {
	last_communication_begin_time_ = GetCurrentTime2();
}

void Timer::CommunicationStop() {
	communication_elapsed_ += GetCurrentTime2() - last_communication_begin_time_;
}

void Timer::SynchronizationStart() {
	last_sync_begin_time_ = GetCurrentTime2();
}

void Timer::SynchronizationStop() {
	sync_elapsed_ += GetCurrentTime2() - last_sync_begin_time_;
}
